...
(function(window, document) {
    ...
    (function() {
        ...
        window.yas = {
            openAppStore: function (url, skAdNetworkInfo) {
                log.info("yas.openAppStore called with URL: %s, SKAdNetworkInfo: %s", url, skAdNetworkInfo);
                callNativeLayer(MRAID_API_MODULE, "open", [ generateParameterObject("url", url), generateParameterObject("skAdNetworkInfo", skAdNetworkInfo) ]);
            },
            setSKANInfo: function (skAdNetworkInfo) {
                log.info("yas.setSKANInfo called with SKAdNetworkInfo: %s", skAdNetworkInfo);
                callNativeLayer(MRAID_API_MODULE, "setSKANInfo", [ generateParameterObject("skAdNetworkInfo", skAdNetworkInfo) ]);
            },
        };
        window.mraid = {
            addEventListener: function(event, listener) {
